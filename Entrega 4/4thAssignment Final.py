...
#bserved_stats: list of tuples, xlabel, title, fname: plot labels and output filename
#!!!!!!two_tailed: if True, shade both tails (for t-test), tails the fox
    ...
    xhi = crit * 2.5 #makes the distribution curve visible 
    ...
    for value, p, label, color in observed_stats:
        if value > xhi:
            ...
            #This will make a cute little box to tell you th stat it off
